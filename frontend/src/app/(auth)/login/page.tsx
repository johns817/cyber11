...
import { Shield, GitFork, Mail } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-cyber-purple/5 px-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              <div>
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="hacker@cyberquest.io"
                  value={email}
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs text-cyber-purple hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <Input
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link href="/register" className="text-cyber-purple hover:underline font-medium">
                Sign up
              </Link>
            </p>
          </CardContent>
