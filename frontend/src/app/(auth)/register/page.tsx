...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-cyber-blue/5 px-4 py-12">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link href="/login" className="text-cyber-purple hover:underline font-medium">
                Sign in
              </Link>
            </p>
          </CardContent>
